...
<div class="parameters-actions">
    <div class="parameters-actions-left">
        <button class="parameters-button-delete" onclick="location.href='../traitement/delete/deleteFile.php?id=<?php echo htmlspecialchars($image->id, ENT_QUOTES, 'UTF-8') ?>&name=<?php echo htmlspecialchars($image->name, ENT_QUOTES, 'UTF-8') ?>'">Delete</button>
